<!--This is the primary header for logged in admin users, shows nav bar for admin dash links  -->
<?php
		...
		<div class="col-xs-12">
			<nav class="navbar navbar-default">
				...
				<ul class="nav navbar-nav">
					...
					<li <?php if($menu == 1) { echo 'class="active"'; } ?>><a href="admindash.php">Admin Dashboard</a></li>
