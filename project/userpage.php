    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="userpage.php"><i class="fa fa-table fa-fw"></i> Enter Work Hours</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
			...
			<div class="input-group bootstrap-timepicker timepicker">
				<div class="col-sm-2">
					<input id="timepicker1" type="text" class="form-control" placeholder="Start Time">
					<span class="input-group-addon"><i class="fa fa-clock-o fa-fw"></i></span>
				</div>
			</div>
			<div class="input-group bootstrap-timepicker timepicker">
				<div class="col-sm-2">
					<input id="timepicker1" type="text" class="form-control" placeholder="End Time">
					<span class="input-group-addon"><i class="fa fa-clock-o fa-fw"></i></span>
				</div> 
			</div>
